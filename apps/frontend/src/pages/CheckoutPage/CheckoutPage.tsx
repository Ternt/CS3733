...
function CheckoutPage({checkoutType, returnPath}: CheckoutProps) {
    ...
    const handleDeleteItem = (indexToRemove: number) => {
        let deleteItemCart = cart.filter((item, index) => index !== indexToRemove);
        setNewCart([deleteItemCart]);
        console.log(cart);
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Box>
                        <Typography style={{fontFamily: "Open Sans"}} color={"whitesmoke"} p={1} textAlign={"center"}
                                    variant={"h3"}>
                            ENTER INFORMATION
                        </Typography>
                    </Box>
